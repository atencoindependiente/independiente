...
<body>				
  ...
  <?php //include("./ra.web/includes/BodyIndex.php"); ?>
        ...
        <div class="container-fluid px-md-5">
            <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
                <div class="col-md-6 ftco-animate">
                    ...
                    <h1 class="mb-4">Por un ATENCO independiente</h1>
        ...
        <div class="container">
            <div class="row d-flex">
                <div class="col-md-6 d-flex">
                    <div class="img img-video d-flex align-self-stretch align-items-center justify-content-center justify-content-md-end" style="background-image:url(./ra.web/img/img1.jpg);">
                        <a href="./ra.web/video/video_feliz_anio.mp4" class="icon-video popup-vimeo d-flex justify-content-center align-items-center">
  ...
  <?php //include("./ra.web/includes/ModalLogin.php");?>		
  ...
  <?php include("./ra.web/includes/ModalNuevoSimpatizante.php");?>
    ...
    <script src="./ra.web/js/index.js"></script>
</html>