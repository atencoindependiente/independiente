<div class="modal fade bd-nuevo-coordinador-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Datos del Coordinador</h5>
            ...
            <div class="modal-body">
              <div class="row">
                <div class="col-md-12 text-center">
									<div class="alert alert-warning alert-dismissable" id="alert_valida_campos_coordinador">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <select class="form-control" id="mdl_coor_localidad" onchange="colocaCP(this.value,'Coordinador');"> 
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="mdl_coor_cp" disabled>
                  </div>
                </div>
                <div class="col-md-3">
                  <label for="for_seccion">Sección:</label>
                  <select class="form-control" id="mdl_coor_seccion"> 
                    <option selected value="0000">Seleccione</option>
              ...
              <div class="row">
                ...
                <div class="col-md-9">
                  <select class="form-control" id="mdl_coor_datos_directivo"> 
              ...
              <div class="row">
                ...
                <div class="col-md-9">
                  <select class="form-control" id="mdl_coor_datos_lider"> 
                    <!--<option selected value="0">Seleccione</option>-->
                  </select>
                </div>
              </div>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-primary" id="btn_guardar_datos_coordinador">Guardar Datos</button>
