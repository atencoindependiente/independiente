...
<nav class="navbar px-md-0 navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
  <div class="container-fluid px-md-5">
    <a class="navbar-brand" href="home.php">Atenco <span>Independiente</span></a>
    ...
    <div class="collapse navbar-collapse" id="ftco-nav">
        ...
        <li class="nav-item"><a href="home_nosotros.php" class="nav-link">Nosotros</a></li>
        <li class="nav-item"><a href="home_secciones.php" class="nav-link">Secciones</a></li>
        <li class="nav-item"><a href="index.php" class="nav-link">Inicia de Sesión</a></li>
