        ...
        <div class="row d-flex">
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <div class="text p-4 float-right d-block">
              	<div class="topper d-flex align-items-center" style="border-radius: 10px;";>
                ...
                <h3 class="heading mt-2"><a href="#">Se crea la asociación civil FOPC</a></h3>
                <p>Con el nombre descrito como <strong>F</strong>rente de <strong>O</strong>rganizaciones <strong>P</strong>opulares y <strong>C</strong>iudadanas, iniciamos estre grandioso proyecto.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <div class="text p-4 float-right d-block">
                ...
                <h3 class="heading mt-2"><a href="#">Se crea el lugar para la Asociación Civil.</a></h3>
          ...
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry justify-content-end" style="border-radius: 10px;">
              ...
              <div class="text p-4 float-right d-block">
                ...
                <h3 class="heading mt-2"><a href="#">1° Reunion oficial de la asociación</a></h3>
                <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <div class="text p-4 float-right d-block">
                ...
                <h3 class="heading mt-2"><a href="#">1° Torneo de Ajedrez</a></h3>
                <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <div class="text p-4 float-right d-block">
                ...
                <h3 class="heading mt-2"><a href="#">2° Torneo de Ajedrez</a></h3>
                <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <div class="text p-4 float-right d-block">
                ...
                <h3 class="heading mt-2"><a href="#">Premiaciones del torneo.</a></h3>
                <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
              </div>
            </div>
          </div>
