...
class EditarSimpatizante{
  ...
  function __construct($mdl_id,$mdl_nombre,$mdl_apaterno,$mdl_amaterno,$mdl_localidad,$mdl_seccion,$mdl_direccion,$mdl_cp,$mdl_tel_celular,$mdl_comentarios,$fecha_movimiento,$motivo_movimiento,$usuario_movimiento,$directivo_id,$lider_id,$coordinador_id)
  { 
    $this->mdl_id=$mdl_id;
    $this->mdl_nombre=$mdl_nombre;
    $this->mdl_apaterno=$mdl_apaterno;
